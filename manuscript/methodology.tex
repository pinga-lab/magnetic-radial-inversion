...
We set the same constant radii for all prisms, so that they approximate a cylinder and 
enclose both positive and negative parts of the observed anomaly.
Also, we set the same constant depth extent $dz$ for all prisms with the purpose 
